 ...
 * @since 2021/9/13
 */
public class LocalDateTimeStryMdHmsKeySerializer extends JsonSerializer<LocalDateTime> {
  ...
  public void serialize(LocalDateTime localDateTime, JsonGenerator jgen, SerializerProvider provider) {
    ...
    jgen.writeFieldName(DateUtils.format(localDateTime, DateUtils.yMdHms_FORMATTER));
  }
