 ...
 * @since 2021/9/13
 */
public class LocalDateTimeStryMdHmsSerializer extends JsonSerializer<LocalDateTime> {
  ...
  public void serialize(LocalDateTime localDateTime, JsonGenerator jgen, SerializerProvider provider) {
    ...
    jgen.writeString(DateUtils.format(localDateTime, DateUtils.yMdHms_FORMATTER));
  }
