...
import cn.addenda.component.jdk.util.collection.BatchUtils;
...
public class IterableUtilsTest {
  ...
  @Test
  public void test2() {
    BatchUtils.applyInBatches(ArrayUtils.asArrayList("a", "b"), new Function<Iterable<String>, Iterable<Void>>() {
      @Override
